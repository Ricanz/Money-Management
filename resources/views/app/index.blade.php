            ...
            <div class="col-xl-4">
                ...
                <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">Rp. 9,998,000</div>
                        <div class="fw-bold text-white">Total Pengeluaran</div>
                    </div>
                    <!--end::Body-->
                </a>
            ...
            <div class="col-xl-4">
                ...
                <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">Rp. 15,000,700</div>
                        <div class="fw-bold text-white">Total Pemasukan</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-4">
                ...
                <a href="#" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">Rp. 87,700,340</div>
                        <div class="fw-bold text-white">Total Tabungan</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
        ...
        <div class="row gy-5 g-xl-8">
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Perduitan Duniawi</span>
                            <span class="text-muted fw-bold fs-7">Statistik Keuangan Bulanan Kamu</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body p-0 d-flex flex-column">
                        ...
                        <div class="card-p pt-5 bg-body flex-grow-1">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col mr-8">
                                    <!--begin::Label-->
                                    <div class="fs-7 text-muted fw-bold">Pengeluaran</div>
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="d-flex align-items-center">
                                        <div class="fs-4 fw-bolder">Rp. 3,000,000</div>
                                ...
                                <div class="col">
                                    <!--begin::Label-->
                                    <div class="fs-7 text-muted fw-bold">Pemasukan</div>
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="fs-4 fw-bolder">Rp. 6,000,000</div>
                                    <!--end::Stat-->
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row g-0 mt-8">
                                ...
                                <div class="col mr-8">
                                    <!--begin::Label-->
                                    <div class="fs-7 text-muted fw-bold">Transaksi</div>
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="fs-4 fw-bolder">280</div>
                                    <!--end::Stat-->
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col">
                                    <!--begin::Label-->
                                    <div class="fs-7 text-muted fw-bold">Sisa Uang Bulanan</div>
                                    <!--end::Label-->
                                    <!--begin::Stat-->
                                    <div class="d-flex align-items-center">
                                        <div class="fs-4 fw-bolder">Rp. 200,000</div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card card-xl-stretch">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Tahan Jajannya!</span>
                            <span class="text-muted fw-bold fs-7">Sisa jajan bulanan kamu</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="pt-5">
                            <p class="text-center fs-6 pb-5">
                                <span class="badge badge-light-danger fs-8">Catatan:</span>&#160;
                                Hayoloohh uang makin nipis
                                <br />jangan checkout atau jajan terus!
                            </p>
                            <a href="#" class="btn btn-primary w-100 py-3">Lihat Detail</a>
                        </div>
                    </div>
                    <!--end::Body-->
                </div>
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                data-kt-menu="true" id="kt_menu_6135741615b9c">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid"
                                                ...
                                                data-dropdown-parent="#kt_menu_6135741615b9c"
